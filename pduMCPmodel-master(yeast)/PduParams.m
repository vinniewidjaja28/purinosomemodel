classdef PduParams< matlab.mixin.SetGet
    ...
    properties
        ...
        q = 1;                  % added, amt of R5P produced by RPIA (µmol/s)                               MCP: 0          human: 8.66*1e9
        ...
        Rc = 9.65e-5;           % radius of MCP (cm) (made larger to match real volume ratio)               MCP: 1e-5       human: 1.25*1e-4
        D = 1e-5;               % diffusion constant (cm^2/s)                                               MCP: 1e-5       human: 1e-5

        kmA = 1e7;              % cm/s permeability of outer membrane to propanal                           MCP: 0.01       human: 1e7
        kmP = 1e7;              % cm/s permeability of outer membrane to 1,2-PD                             MCP: 0.01       human: 1e7
        
        alpha = 0;              % reaction rate of conversion of CO2 to HCO3- at the cell membrane (cm/s)   MCP: 0          human: 0
        Pout = .5;               % uM concentration of 1,2-PD outside                                        MCP: 55*1e3     human: 5
        Aout = 0;               % uM concentration of propanal outside

        kcatCDE = 4.24;         % rxns/s maximum reaction rate at single PduCDE active site                 MCP: 300        human: 4.24   
        NCDE = 7.1e3;           % number of PduCDE active sites (updated based on MFS data)                 MCP: 1500       human: 3.38*1e5
        KCDE= 490;              % half max reaction rate of PduCDE, uM                                      MCP: 0.5*1e3    human: 490
        kcatPQ = 9.57e-4        % rxns/s maximum rate of aldehyde consumption by PduP/PduQ                  MCP: 55         human: 3.98e-3
        NPQ = 1.76*1e6;         % number of PduP/PduQ active sites (updated based on MFS data)              MCP: 2500       human: 1.76*1e6
